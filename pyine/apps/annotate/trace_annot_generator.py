...
async def main(
    ...
    if prompt_vars:
        inline_vars = _shared.ensure_mapping_dict(
            _shared.parse_yaml_or_json_value(prompt_vars),
    ...
    if shared_meta_file is not None:
        file_meta = _shared.ensure_mapping_dict(
            _shared.load_yaml_or_json_file(shared_meta_file),
