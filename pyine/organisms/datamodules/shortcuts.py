...
class ShortcutBiasDataModuleConfig(pyine.data.datamodule.BaseDataModuleConfig):
    ...
    dataparser_config_overrides: dict[pyine.data.datamodule.SubsetNameType, dict[str, typing.Any]] = dict(
        train=dict(
    ...
    dataloader_config_overrides: dict[pyine.data.datamodule.SubsetNameType, dict[str, typing.Any]] = dict(
...
class ShortcutBiasDataModule(pyine.data.datamodule.BaseDataModule):
    ...
    def __init__(
        ...
        self._subset_parsers: dict[pyine.data.datamodule.SubsetNameType, SampleDataParserType] = dict()
    ...
    def prepare_data(self) -> None:
        ...
        subset_traces_meta: dict[pyine.data.datamodule.SubsetNameType, list[TraceMetadata]] = dict()
        ...
        for subset_name in set(potential_subset_names):  # init trace lists for all potential subsets
        ...
        # @@@@@@ TODO extra step: stratified split w/ clustering (?)
    ...
    ) -> pyine.data.datamodule.SubsetNameType | None:
    ...
    def get_parser(
        self,
        subset_type: pyine.data.datamodule.SubsetNameType | None = None,
    ) -> SampleDataParserType:
    ...
    def _make_dataloader(
        self,
        subset_type: pyine.data.datamodule.SubsetNameType | None,
    ) -> SampleDataLoaderType:
