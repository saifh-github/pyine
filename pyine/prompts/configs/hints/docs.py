...
def get_prompt_template(
    ...
    """Returns the prompt template for the hinting-via-documentation prompt (manager module override).

    Note: this implementation appropriately fills in all relevant partial variables, if any.
    """
    import pyine.prompts.manager

    prompt_config = pyine.prompts.manager.get_prompt_config("hints/docs", version=version)
