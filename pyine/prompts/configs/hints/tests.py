...
def get_prompt_config(
    ...
    """Return the prompt configuration for the hinting-via-runtime test artifacts prompt.
...
"""Specialized version of `get_prompt_template` for the hinting-via-runtime tests prompt."""
