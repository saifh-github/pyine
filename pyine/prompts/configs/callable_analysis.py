...
type CallableAnalysisOutputParser = langchain_core.output_parsers.PydanticOutputParser[CallableAnalysisResponse]
"""Type of the LangChain pydantic output parser specialized in parsing callable analysis responses."""


def get_output_parser(
    version: "pyine.prompts.types.PromptVersionType | None" = None,
) -> CallableAnalysisOutputParser:
