...
def get_prompt_config(
    ...
    """Return the prompt configuration for the TODOs/FIXMEs prompt.
...
"""Specialized version of `get_prompt_template` for the TODOs/FIXMEs prompt."""
