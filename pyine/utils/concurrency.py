...
"""
ProcessorFuncType = typing.Callable[[InputItemType, OutputItemType], None]
...
"""
ProgressCallbackType = typing.Callable[[list[InputItemType], list[InputItemType]], None]
...
def run_with_sliding_window(
    ...
    """Run a job submission function with a sliding window of in-flight jobs.
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=max_workers) as executor:
        ...
        while in_flight:
            ...
            process_result(item, done.result())
