...
SubmissionFuncType = typing.Callable[[InputItemType, concurrent.futures.Executor | None], concurrent.futures.Future]
...
"""
ProcessorFuncType = MaybeAsyncCallable[[InputItemType, OutputItemType | None], None]
...
async def run_with_sliding_window(
    ...
    submit_one: SubmissionFuncType,  # noqa
    process_result: ProcessorFuncType,  # noqa
